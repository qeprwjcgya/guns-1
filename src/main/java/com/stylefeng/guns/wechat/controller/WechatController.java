 ...
 */
@RestController
@RequestMapping(value = "/wechat/portal", produces = {"application/json;charset=UTF-8"})
public class WechatController {
    ...
    public ResponseEntity<String> authGet(@RequestParam(name = "signature", required = false) String signature,
    ...
    public String post(@RequestBody String requestBody, @RequestParam("signature") String signature,
        ...
        if (encType == null) {
            ...
            WxMpXmlMessage inMessage = WxMpXmlMessage
                    .fromEncryptedXml(requestBody, this.wxService.getWxMpConfigStorage(), timestamp, nonce,
                                      msgSignature);
            this.logger.debug("\n消息解密后内容为：\n{} ", inMessage.toString());
            WxMpXmlOutMessage outMessage = this.route(inMessage);
            if (outMessage == null) {
