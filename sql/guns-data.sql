...
CREATE TABLE `rcwl_car`  (
  ...
  `car_series` int(11) NOT NULL COMMENT '车系列',
  `car_series_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系列名称',
  `car_type` int(11) DEFAULT NULL COMMENT '车型',
  `car_number_region` int(11) DEFAULT NULL COMMENT '牌照所属区域(渝A),ID',
  ...
  `car_insurance_time` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '投保时间',
  ...
  `car_status` int(10) DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
-- Records of rcwl_car
-- ----------------------------
INSERT INTO `rcwl_car` VALUES (1, 1, 1, '长安', 1, 1, '渝A', 'BM760', 'BEAN', '2018-05-20', 1, '平安', NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `rcwl_user` VALUES (35467371456486804, '预见', NULL, 'http://thirdwx.qlogo.cn/mmopen/pKj0EaSicgZ2pjxMLCp4Yll60eJTZO3pgq3t97QKvg0VhgWbk5av1YTOHln9fWcHCmJ8RubsCDVy19YlMOpxrtU4y3cLicxPen/132', 'osYGJwejxrSeKhs1b305ZG7DFyxE', '15823432144', 1, '重庆', '两江新区', '中国', '2018-04-22 17:55:44', NULL);
